...
class MPU9250
{
	...
	// Specify sensor full scale resolution
	uint8_t Gscale = GFS_1000DPS;
	uint8_t Ascale = AFS_8G;
	uint8_t Mscale = MFS_16BITS; // Choose either 14-bit or 16-bit magnetometer resolution
	uint8_t Mmode = 0x06; // Sampling frequency magnetometer, 0x02 = 8Hz and 0x06 = 100Hz
